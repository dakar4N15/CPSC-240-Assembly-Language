...
//  Compile: gcc -c -m64 -Wall -std=c17 -fno-pie -no-pie -o quick_sort.o quick_sort.c
//  Link: g++ -m64 -std=c++17 -fno-pie -no-pie -o final.out main.o executive.o fill_random_array.o show_array.o quick_sort.o normalize.o isnan.o
//
//Execution: ./final.out
//
//===== Begin code area ===================================================================================================================================================
