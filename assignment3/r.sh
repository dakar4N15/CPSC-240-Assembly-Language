...
gcc -c -m64 -Wall -std=c17 -fno-pie -no-pie -o quick_sort.o quick_sort.c

echo "Compile normalize.asm"
nasm -f elf64 -l normalize.lis -o normalize.o normalize.asm

echo "Link object files using the gcc linker standard 2017"
g++ -m64 -std=c++17 -fno-pie -no-pie -o final.out main.o executive.o fill_random_array.o show_array.o quick_sort.o normalize.o isnan.o
